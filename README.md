...
After cloning the repository, please move `.env.template` to `.env` and fill the variables. You might have also received the ready `.env` file in separate communication.
